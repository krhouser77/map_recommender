 ...
 */
abstract class Card implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\MapRec\\MapRecBundle\\Model\\Map\\CardTableMap';
    ...
    /**
     * The value for the required_count field.
     *
     * @var        int
     */
    protected $required_count;
    ...
    /**
     * Initializes internal state of MapRec\MapRecBundle\Model\Base\Card object.
     */
    ...
    /**
     * Compares this with another <code>Card</code> instance.  If
     * <code>obj</code> is an instance of <code>Card</code>, delegates to
     * <code>equals(Card)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Card The current object, for fluid interface
     */
    ...
    /**
     * Get the [required_count] column value.
     *
     * @return int
     */
     ...
     * @return $this|\MapRec\MapRecBundle\Model\Card The current object (for fluent API support)
     */
    public function setCardId($v)
    {
        ...
        if ($this->card_id !== $v) {
            $this->card_id = $v;
            $this->modifiedColumns[CardTableMap::COL_CARD_ID] = true;
        }
    ...
    public function setCardName($v)
    {
        ...
        if ($this->card_name !== $v) {
            $this->card_name = $v;
            $this->modifiedColumns[CardTableMap::COL_CARD_NAME] = true;
        }
    ...
    /**
     * Set the value of [required_count] column.
     *
     * @param int $v new value
     * @return $this|\MapRec\MapRecBundle\Model\Card The current object (for fluent API support)
     */
    public function setRequiredCount($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->required_count !== $v) {
            $this->required_count = $v;
            $this->modifiedColumns[CardTableMap::COL_REQUIRED_COUNT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CardTableMap::translateFieldName('CardId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->card_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CardTableMap::translateFieldName('CardName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->card_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CardTableMap::translateFieldName('RequiredCount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->required_count = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = CardTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MapRec\\MapRecBundle\\Model\\Card'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCardQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCardQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CardTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null !== $this->card_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . CardTableMap::COL_CARD_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(CardTableMap::COL_CARD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'card_id';
        }
        if ($this->isColumnModified(CardTableMap::COL_CARD_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'card_name';
        }
        if ($this->isColumnModified(CardTableMap::COL_REQUIRED_COUNT)) {
            $modifiedColumns[':p' . $index++]  = 'required_count';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'card_name':
                        ...
                        break;
                    case 'required_count':
                        $stmt->bindValue($identifier, $this->required_count, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = CardTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Card'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Card'][$this->hashCode()] = true;
        $keys = CardTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCardId(),
            $keys[1] => $this->getCardName(),
            $keys[2] => $this->getRequiredCount(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\MapRec\MapRecBundle\Model\Card
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setCardId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setCardName($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setRequiredCount($arr[$keys[2]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\MapRec\MapRecBundle\Model\Card The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CardTableMap::COL_CARD_ID)) {
            $criteria->add(CardTableMap::COL_CARD_ID, $this->card_id);
        }
        if ($this->isColumnModified(CardTableMap::COL_CARD_NAME)) {
            $criteria->add(CardTableMap::COL_CARD_NAME, $this->card_name);
        }
        if ($this->isColumnModified(CardTableMap::COL_REQUIRED_COUNT)) {
            $criteria->add(CardTableMap::COL_REQUIRED_COUNT, $this->required_count);
        }
    ...
    {
        $criteria = ChildCardQuery::create();
        $criteria->add(CardTableMap::COL_CARD_ID, $this->card_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MapRec\MapRecBundle\Model\Card (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setRequiredCount($this->getRequiredCount());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MapRec\MapRecBundle\Model\Card Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCard is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildCard The current object (for fluent API support)
     */
     ...
     * @return ObjectCollection|ChildCardToMap[] List of ChildCardToMap objects
     */
    public function getCardToMapsJoinMap(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCardToMapQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(CardTableMap::DEFAULT_STRING_FORMAT);
    }
